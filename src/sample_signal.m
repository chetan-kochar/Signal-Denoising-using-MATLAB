...
comp_singal1 = a1*sin(2*pi*f1*t);
comp_singal2 = a2*sin(2*pi*f2*t);
comp_singal3 = a3*sin(2*pi*f3*t);

signal_pure = comp_singal1 + comp_singal2 + comp_singal3;
...
subplot(4,1,4)
plot(t, signal_pure, 'k-', 'LineWidth', 2)
